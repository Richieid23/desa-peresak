...
@section('title')
    Karang Taruna - Lembaga Masyarakat Desa Peresak
@endsection
...
@section('content')
    <div role="main" class="main">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col p-static">
                        <h1 data-title-border>KARANG TARUNA</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section section-primary border-0 mb-0 appear-animation" data-appear-animation="fadeIn" data-plugin-options="{'accY': -150}"></section>
            <div class="container">
